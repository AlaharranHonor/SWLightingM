...
public class BlockInit {
    ...
    public static final RegistryObject<Block> WAXED_COPPER_BLOCK = BLOCKS.register("waxed_copper_block", () -> new Block(BlockBehaviour.Properties.copy(Blocks.WAXED_COPPER_BLOCK).lightLevel((state) -> 15)));
    public static final RegistryObject<Block> WAXED_CUT_COPPER = BLOCKS.register("waxed_cut_copper", () -> new Block(BlockBehaviour.Properties.copy(Blocks.WAXED_CUT_COPPER).lightLevel((state) -> 15)));
    public static final RegistryObject<Block> WAXED_OXIDIZED_COPPER = BLOCKS.register("waxed_oxidized_copper", () -> new Block(BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER).lightLevel((state) -> 15)));
    public static final RegistryObject<Block> WAXED_OXIDIZED_CUT_COPPER = BLOCKS.register("waxed_oxidized_cut_copper", () -> new Block(BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_CUT_COPPER).lightLevel((state) -> 15)));
    public static final RegistryObject<Block> WAXED_EXPOSED_COPPER = BLOCKS.register("waxed_exposed_copper", () -> new Block(BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER).lightLevel((state) -> 15)));
