...
public class SWDMInit {
	...
	* Store the reference to the block, and then in the item initialization register the items and block items.
	...
	public static void intializeModBlocks(RegistryEvent.Register<Block> item) {
		if (false && ModList.get().isLoaded("swdm")) {
	...
	public static void intializeModItems(RegistryEvent.Register<Item> item) {
		if (false && ModList.get().isLoaded("swdm")) {
			...
			item.getRegistry().register(new BlockItem(MOSSY_STONE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MOSSY_STONE.getRegistryName()));
			item.getRegistry().register(new BlockItem(MORE_MOSSY_STONE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MORE_MOSSY_STONE.getRegistryName()));
			item.getRegistry().register(new BlockItem(CRACKED_STONE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(CRACKED_STONE.getRegistryName()));
			item.getRegistry().register(new BlockItem(MOSSY_ANDESITE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MOSSY_ANDESITE.getRegistryName()));
			item.getRegistry().register(new BlockItem(MORE_MOSSY_ANDESITE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MORE_MOSSY_ANDESITE.getRegistryName()));
			item.getRegistry().register(new BlockItem(CRACKED_ANDESITE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(CRACKED_ANDESITE.getRegistryName()));
			item.getRegistry().register(new BlockItem(MOSSY_DIORITE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MOSSY_DIORITE.getRegistryName()));
			item.getRegistry().register(new BlockItem(MORE_MOSSY_DIORITE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MORE_MOSSY_DIORITE.getRegistryName()));
			item.getRegistry().register(new BlockItem(CRACKED_DIORITE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(CRACKED_DIORITE.getRegistryName()));
			item.getRegistry().register(new BlockItem(MOSSY_GRANITE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MOSSY_GRANITE.getRegistryName()));
			item.getRegistry().register(new BlockItem(MORE_MOSSY_GRANITE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MORE_MOSSY_GRANITE.getRegistryName()));
			item.getRegistry().register(new BlockItem(CRACKED_GRANITE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(CRACKED_GRANITE.getRegistryName()));
			item.getRegistry().register(new BlockItem(THATCH_BLOCK, new Item.Properties().tab(SWLM.TAB)).setRegistryName(THATCH_BLOCK.getRegistryName()));
			item.getRegistry().register(new BlockItem(BAMBOO_BLOCK, new Item.Properties().tab(SWLM.TAB)).setRegistryName(BAMBOO_BLOCK.getRegistryName()));
			item.getRegistry().register(new BlockItem(SAND_BLACK, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SAND_BLACK.getRegistryName()));
			item.getRegistry().register(new BlockItem(SAND_BLUE_GRAY, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SAND_BLUE_GRAY.getRegistryName()));
			item.getRegistry().register(new BlockItem(SAND_BROWN, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SAND_BROWN.getRegistryName()));
			item.getRegistry().register(new BlockItem(SAND_DARK_BROWN, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SAND_DARK_BROWN.getRegistryName()));
			item.getRegistry().register(new BlockItem(SAND_DUSTED_GRAY, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SAND_DUSTED_GRAY.getRegistryName()));
			item.getRegistry().register(new BlockItem(SAND_GOLDEN, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SAND_GOLDEN.getRegistryName()));
			item.getRegistry().register(new BlockItem(SAND_GRAY, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SAND_GRAY.getRegistryName()));
			item.getRegistry().register(new BlockItem(SAND_LIGHT_GRAY, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SAND_LIGHT_GRAY.getRegistryName()));
			item.getRegistry().register(new BlockItem(SAND_MUTED_BROWN, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SAND_MUTED_BROWN.getRegistryName()));
			item.getRegistry().register(new BlockItem(SAND_VIVID_RED, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SAND_VIVID_RED.getRegistryName()));
			item.getRegistry().register(new BlockItem(SAND_WHITE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SAND_WHITE.getRegistryName()));
			item.getRegistry().register(new BlockItem(SANDSTONE_BLACK, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SANDSTONE_BLACK.getRegistryName()));
			item.getRegistry().register(new BlockItem(SANDSTONE_BLUE_GRAY, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SANDSTONE_BLUE_GRAY.getRegistryName()));
			item.getRegistry().register(new BlockItem(SANDSTONE_BROWN, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SANDSTONE_BROWN.getRegistryName()));
			item.getRegistry().register(new BlockItem(SANDSTONE_DARK_BROWN, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SANDSTONE_DARK_BROWN.getRegistryName()));
			item.getRegistry().register(new BlockItem(SANDSTONE_DUSTED_GRAY, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SANDSTONE_DUSTED_GRAY.getRegistryName()));
			item.getRegistry().register(new BlockItem(SANDSTONE_GOLDEN, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SANDSTONE_GOLDEN.getRegistryName()));
			item.getRegistry().register(new BlockItem(SANDSTONE_GRAY, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SANDSTONE_GRAY.getRegistryName()));
			item.getRegistry().register(new BlockItem(SANDSTONE_LIGHT_GRAY, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SANDSTONE_LIGHT_GRAY.getRegistryName()));
			item.getRegistry().register(new BlockItem(SANDSTONE_MUTED_BROWN, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SANDSTONE_MUTED_BROWN.getRegistryName()));
			item.getRegistry().register(new BlockItem(SANDSTONE_VIVID_RED, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SANDSTONE_VIVID_RED.getRegistryName()));
			item.getRegistry().register(new BlockItem(SANDSTONE_WHITE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(SANDSTONE_WHITE.getRegistryName()));
			item.getRegistry().register(new BlockItem(BLACK_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(BLACK_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(BLUE_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(BLUE_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(BROWN_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(BROWN_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(CYAN_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(CYAN_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(GRAY_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(GRAY_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(GREEN_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(GREEN_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(LIGHT_BLUE_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(LIGHT_BLUE_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(LIGHT_GRAY_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(LIGHT_GRAY_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(LIME_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(LIME_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(MAGENTA_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MAGENTA_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(ORANGE_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(ORANGE_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(PINK_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(PINK_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(PURPLE_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(PURPLE_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(RED_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(RED_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(WHITE_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(WHITE_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(YELLOW_DARK_PRISMARINE, new Item.Properties().tab(SWLM.TAB)).setRegistryName(YELLOW_DARK_PRISMARINE.getRegistryName()));
			item.getRegistry().register(new BlockItem(BLACK_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(BLACK_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(BLUE_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(BLUE_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(BROWN_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(BROWN_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(CYAN_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(CYAN_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(GRAY_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(GRAY_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(GREEN_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(GREEN_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(LIGHT_BLUE_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(LIGHT_BLUE_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(LIGHT_GRAY_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(LIGHT_GRAY_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(LIME_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(LIME_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(MAGENTA_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MAGENTA_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(ORANGE_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(ORANGE_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(PINK_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(PINK_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(PURPLE_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(PURPLE_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(RED_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(RED_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(WHITE_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(WHITE_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(YELLOW_GLASS_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(YELLOW_GLASS_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(LIGHT_STONE_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(LIGHT_STONE_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(MEDIUM_STONE_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MEDIUM_STONE_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(DARK_STONE_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(DARK_STONE_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(LIGHT_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(LIGHT_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(MEDIUM_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MEDIUM_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(DARK_BRICKS, new Item.Properties().tab(SWLM.TAB)).setRegistryName(DARK_BRICKS.getRegistryName()));
			item.getRegistry().register(new BlockItem(LIGHT_CLAY_BLOCK, new Item.Properties().tab(SWLM.TAB)).setRegistryName(LIGHT_CLAY_BLOCK.getRegistryName()));
			item.getRegistry().register(new BlockItem(MEDIUM_CLAY_BLOCK, new Item.Properties().tab(SWLM.TAB)).setRegistryName(MEDIUM_CLAY_BLOCK.getRegistryName()));
			item.getRegistry().register(new BlockItem(DARK_CLAY_BLOCK, new Item.Properties().tab(SWLM.TAB)).setRegistryName(DARK_CLAY_BLOCK.getRegistryName()));
		}
	}
